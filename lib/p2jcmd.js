...
let optimist = require('optimist')
    ...
    .alias('e', 'extractImages')
    .describe('e', '(optional) when specified, will extract embedded images to output directory.\n')
    .alias('t', 'fieldTypes')
...
const EXTRACT_IMAGES = _.has(argv, 'e');
...
let PDF2JSONUtil = (function () {
	...
	let _parseOnePDFStream = function(callback) {
		this.pdfParser = new PDFParser(null, PROCESS_RAW_TEXT_CONTENT, this.imageExtractDir);
    ...
    let cls = function (inputDir, inputFile, curProcessor) {
        ...
        this.imageExtractDir = EXTRACT_IMAGES ? this.outputDir : null;
